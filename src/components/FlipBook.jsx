      ...
      <div className="flip-book">
        ...
        <div className="flip" id="p2">
          ...
          <div className="back">
            ...
            <p>
              I discovered coding. I loved it. It stimulated me and sent me into
              a flow state like I’d never before experienced. I was hooked!
            </p>
        ...
        <div className="flip" id="p3">
          ...
          <div className="back">
            <p>
              ... aimlessly bounced between different programming languages and
              technologies with no direction and no end goal in sight.
            </p>
